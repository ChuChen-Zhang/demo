...
Page({
  ...
  target: function (options) {
    ...
    const _type = 2;
    wx.reLaunch({
      url: '../../pages/face/face?' + 'type=' + _type + '&&name=' + empty + '&&idcard=' + empty + '&&phone=' + empty + '&&mark=' + empty + '&&addrLevel_1=' + _addrLevel_1 + '&&addrLevel_2=' + _addrLevel_2 + '&&addrLevel_3=' + _addrLevel_3
    })
  },
  /**
   * 生命周期函数--监听页面加载
